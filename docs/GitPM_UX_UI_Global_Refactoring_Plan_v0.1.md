...
- [x] Сгруппировать меню:
  - Планирование: Проекты, Задачи, Доска, Гант, Загрузка;
  - Команда: Люди, Календари;
  - Репозиторий: Рабочие копии, Изменения, История, Настройки.
- [x] Добавить breadcrumbs для проекта, задачи и commit detail.
- [x] Упростить topbar и перенести абсолютный путь репозитория в подробности.
...
## UX03. Проекты, этапы и полноценный редактор задач
...
- Перевести Проекты и Этапы с множества inline-форм на list-detail layout.
- Явно показывать, к какому проекту относятся этапы.
...
- create/update/archive/delete tests для проектов, этапов и задач;
...
- Добавить легенду задач, этапов и зависимостей.
...
- Проекты и Доска на демо: ready state не более 1 секунды.
...
- UX05;
- управляемые Доска, Гант и Загрузка.
...
- создать проект, этап и полностью заполненную задачу;
