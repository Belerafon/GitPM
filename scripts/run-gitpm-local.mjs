...
import { readBuildVersion, VERSION_UNAVAILABLE } from "./git-version.mjs";

const capturedVersion = readBuildVersion()?.version ?? VERSION_UNAVAILABLE;
console.log(`[GitPM] Версия сборки: ${capturedVersion}`);
