...
class BrowserAcceptanceApi implements GitPmApi {
  ...
  async createDraft(draftId: string) {
    ...
    if (window.location.pathname.endsWith("vfy-027.html")) {
      ...
      this.entities = [
        this.entityResult({ schema: "gitpm/project@2", id: project, name: "Beta portfolio", status: "backlog", lifecycle: "active" }),
        this.entityResult({ schema: "gitpm/milestone@2", id: milestone, project, name: "Beta release", due: "2026-07-08", lifecycle: "active" }),
        this.entityResult({ schema: "gitpm/task@2", id: ids[0]!, project, title: "Plan release", type: "task", status: "done", lifecycle: "active", start: "2026-07-01", due: "2026-07-05" }),
        this.entityResult({ schema: "gitpm/task@2", id: ids[1]!, project, title: "Build API", type: "task", status: "done", lifecycle: "active", start: "2026-07-02", due: "2026-07-03", parent: ids[0], milestone }),
        this.entityResult({ schema: "gitpm/task@2", id: ids[2]!, project, title: "Ship UI", type: "task", status: "in-progress", lifecycle: "active", start: "2026-07-04", due: "2026-07-06", depends_on: [ids[1]!] }),
        this.entityResult({ schema: "gitpm/task@2", id: ids[3]!, project, title: "Review", type: "task", status: "backlog", lifecycle: "active", start: "2026-07-06", due: "2026-07-07", depends_on: [ids[2]!] }),
        this.entityResult({ schema: "gitpm/task@2", id: ids[4]!, project, title: "Launch", type: "task", status: "backlog", lifecycle: "active", start: "2026-07-08", due: "2026-07-08", depends_on: [ids[3]!] }),
        ...
        this.entityResult({ schema: "gitpm/task@2", id: "T-26-999999", project, title: "Archived hidden", type: "task", status: "done", lifecycle: "archived", start: "2026-07-01", due: "2026-07-02" }),
      ];
      this.changedFiles = [];
    }
    if (window.location.pathname.endsWith("vfy-028.html") || window.location.pathname.endsWith("vfy-032.html")) {
      ...
      this.entities = [
        ...
        this.entityResult({ schema: "gitpm/task@2", id: "T-26-555555", project, title: "Shared delivery", type: "task", status: "in-progress", lifecycle: "active", estimate_hours: 40, start: "2026-07-06", due: "2026-07-10", assignees: [ada, linus] }),
        this.entityResult({ schema: "gitpm/task@2", id: "T-26-666666", project, title: "Ada follow-up", type: "task", status: "backlog", lifecycle: "active", estimate_hours: 30, start: "2026-07-09", due: "2026-07-15", assignees: [ada] }),
        this.entityResult({ schema: "gitpm/task@2", id: "T-26-777777", project, title: "Undated excluded", type: "task", status: "backlog", lifecycle: "active", estimate_hours: 10, assignees: [ada] }),
        this.entityResult({ schema: "gitpm/task@2", id: "T-26-888888", project, title: "Archived excluded", type: "task", status: "done", lifecycle: "archived", estimate_hours: 10, start: "2026-07-06", due: "2026-07-10", assignees: [ada] }),
      ];
      this.changedFiles = [];
    }
