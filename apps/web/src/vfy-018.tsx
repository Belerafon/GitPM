...
class BrowserAcceptanceApi implements GitPmApi {
  ...
  async commitDetail(_draftId: string, commit: string) { return { ...(await this.history())[0]!, commit, body: "", files: [{ path: "projects/P-26-A1PHA1/tasks/T-26-H1ST0R.yaml", status: "Modified" as const, additions: 1, deletions: 1 }], diff: "@@ -1 +1 @@\n-title: Before\n+title: After\n" }; }
