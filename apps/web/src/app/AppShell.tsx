...
const NAVIGATION_ICON: Partial<Record<MessageKey, ReactNode>> = {
  ...
  "nav.administration": <svg aria-hidden="true" viewBox="0 0 16 16"><path d="M2 4h12M2 8h12M2 12h12" /><circle cx="6" cy="4" r="1.5" /><circle cx="10.5" cy="8" r="1.5" /><circle cx="5" cy="12" r="1.5" /></svg>,
};
