    ...
    >
        ...
        {["nav.people", "nav.calendar", "nav.settings"].includes(view) && (active === undefined
          ...
          : view === "nav.people" && workspaceSelection.personId !== undefined
            ...
            : <AdminWorkspace api={api} confirmAction={confirmAction} draft={active} role={drafts.session.role} locale={locale} onOpenPerson={(personId) => openWorkspace("people", { personId })} onOpenProject={(projectId) => openWorkspace("projects", { projectId })} surface={view === "nav.people" ? "people" : view === "nav.calendar" ? "calendar" : "settings"} onChanged={drafts.refresh} />)}
